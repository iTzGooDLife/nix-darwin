...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Camilo"
    user-mail-address "cvera@fluidattacks.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/cvera/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/cvera/bin" "/profile/bin" "/Users/cvera/.npm-packages/bin" "/Users/cvera/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
